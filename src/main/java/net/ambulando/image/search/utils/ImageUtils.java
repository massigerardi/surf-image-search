...
public class ImageUtils {
    ...
    /**
     * a main method to resize single image or content of folders it accept the
     * following arguments java ImageUtils W[xH] file|folder
     * 
     * where W is the Width H is the Height file is the file to resize folder is
     * the folder to resize
     * 
     ...
     * the proportion are not kept the new images will have the original name
     * with the suffix -th
     * 
     * @param width
     * @param height
    ...
    /**
     * resize the images in a folder with a maximum size the image will be
     * resized according to their orientation the new size will be applied to
     * the maximum dimension the proportion are kept
     * 
     * @param size
     * @param folder
     * @throws IOException
    ...
    /**
     * returns an image with the exact dimension provided the proportion are not
     * kept
     * 
     * @param width
     * @param height
     * @param file
     *            the file path for the image to be resized
     * @return
     */
    ...
    /**
     * returns an image with the exact dimension provided the proportion are not
     * kept the image will be saved in the destination file if destination file
     * is null, the original name with suffix -th will be used
     * 
     * @param width
     * @param height
     * @param src
    ...
    /**
     * returns an image with the maximum dimension provided the image will be
     * resized according to their orientation the new size will be applied to
     * the maximum dimension the proportion are kept
     * 
     * @param width
     ...
     * returns an image with the maximum dimension provided the image will be
     * resized according to their orientation the new size will be applied to
     * the maximum dimension the proportion are kept the image will be saved in
     * the destination file if destination file is null, the original name with
     * suffix -th will be used
     * 
     * @param size
     * @param src
     *            the file path for the image to be resized
